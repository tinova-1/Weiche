...
public class Cube extends Body {
	...
	public enum View {
		CENTER_OF_CUBE(0, 0, 0), LOWER_LEFT_CORNER(0.5, 0.5, 0.5), CENTER_UPPER_PLANE(0, 0,
				-0.5), CENTER_FRONT_LOWER_LINE(0, 0.5, 0.5);
		...
		public ArrayList<Point> move(ArrayList<Point> points, double x, double y, double z) {
	...
	/**
	 * method 0: c is center of cube <br>
	 * method 1: c is on lower left corner of cube method 2: c is center of upper
	 * plane <br>
	 * method 3: c is center of front lower line
	 */
